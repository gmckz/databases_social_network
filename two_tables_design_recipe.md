...
user account, email address, username, timeline, posts, post title, post content, number of views
```
...
| posts                 | post title, post content, number of views
...
2. Name of the second table (always plural): `posts` 
    ...
    Column names: `post_title`, `post_content`, `number_of_views`
